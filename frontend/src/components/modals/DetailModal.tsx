            ...
            <div className="flex-1 overflow-y-auto thin-scroll pr-2 pb-2" style={{ maxHeight: item.isManual ? '100%' : '90%' }}>
              <div className="flex flex-col gap-4 pr-1">
                ...
                {!item.isManual && (
                  <div
                    className={cn(
                      "cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md p-2 transition-colors",
                      selectedContexts.includes(item.reasoning) && "bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-500"
                    )}
                    onClick={() => toggleContext(item.reasoning)}
                    title="Klik untuk menambahkan reasoning sebagai konteks chatbot"
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {selectedContexts.includes(item.reasoning) && (
                        <span className="ml-auto text-xs text-blue-600 dark:text-blue-400 font-medium">
                          ✓ Dipilih sebagai konteks
                        </span>
                      )}
                      {!selectedContexts.includes(item.reasoning) && (
                        <span className="ml-auto text-xs text-gray-400 dark:text-gray-500">
                          Klik untuk tambah ke konteks
                        </span>
                      )}
                    </div>
                ...
                {!item.isManual && (
                  <div
                    className={cn(
                      "cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md p-2 transition-colors",
                      selectedContexts.includes("Gambar Terkait") && "bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-500"
                    )}
                    onClick={() => toggleContext("Gambar Terkait")}
                    title="Klik untuk menambahkan informasi gambar sebagai konteks chatbot"
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="h-4 w-4 fill-current">
                      ...
                      {selectedContexts.includes("Gambar Terkait") && (
                        <span className="ml-auto text-xs text-blue-600 dark:text-blue-400 font-medium">
                          ✓ Dipilih sebagai konteks
                        </span>
                      )}
