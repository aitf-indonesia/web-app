...
def get_audit_history(db: Session, id_result: int) -> list:
    ...
    for row in rows:
        ...
        if action == "created":
            ...
            message = f"Generated by {username}"
        elif action == "manual_domain_added":
            message = f"Added manual by {username}"
            ...
            message = f"Note deleted by {username}"
        elif action == "domain_deleted":
            message = f"Deleted by {username}"
        else:
